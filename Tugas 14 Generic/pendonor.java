...
public abstract class pendonor implements nohp {
    ...
    //enkasuplasi
    private String kopy = "\t\t\t Copyright © 2017 PMI Kota Bandung"; 
    ...
    public void judulpendonor() {
       System.out.println("============================================================================");
       System.out.println("                              Data pendonor                                 ");
       System.out.println("============================================================================");
    }
   
    public void Riwayatdonor() {
        System.out.println("Donor Pertama");
    }
}